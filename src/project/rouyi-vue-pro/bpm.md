...
* 第三步，重启后端项目，确认功能是否生效
 ...
 ② 第二步，修改 `yudao-server` 的 [`pom.xml`](https://github.com/YunaiV/ruoyi-vue-pro/blob/master/yudao-server/pom.xml) 文件，取消 `yudao-module-bpm-biz` 依赖的注释，并进行 IDEA 的 Maven 刷新。
