...
export default defineComponent({
    name: "BlogHero",
    setup() {
        const defaultHeroBgImagePath = withBase("/assets/home_bg.jpg");
        ...
        const rDisabled = computed(() =>
            bingDatasRef.value &&
            bingIndex.value == bingDatasRef.value.length - 1
                ? true
                : false,
        );
        const leftClick = () => {
                ...
                if (res.status == 200) {
                    for (const [index, image] of res.data.images.entries()) {
                        ...
                        if (index == 0) {
                            ...
                            f &&
                                (f.style.backgroundImage = `url(${image.url})`);
                              ...
                              () =>
                                  heroImage.value
                                      ? h("img", {
                                            ...
                                            style: frontmatter.value
                                                .heroImageStyle,
                                            src: withBase(heroImage.value),
                                            alt:
                                                frontmatter.value.heroAlt ||
                                                "hero image",
                                        })
                                      : null,
                          ),
...
#hitokoto_author {
    ...
    transition:
        ...
        opacity 1.2s ease-in-out 0.25s;
